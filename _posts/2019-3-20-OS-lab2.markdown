...
3. 使用fork系统调用，创建如下进程树，并使每个进程输出自己的ID和父进程的ID。观察进程的执行顺序和运行状态的变化。![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14paijwfrj30x30buwfa.jpg%29)
...
1. 打开一个vi进程，同时使用另一个终端进行进程查询，使用 **ps** 指令 
   ...
   ![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14pbqayf5j30zs02n75g.jpg%29)
...
2. 寻找vi的父进程
   ...
   ![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14pj5pn33j30zw04cgnh.jpg%29)
...
3. 通过pstree进行部分查询，可以得到如下进程树，发现和我的是一致的
   ...
   ![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14pe8poddj310y0a1t9f.jpg%29)
...
3. 利用ps -al指令进行查看进程
   ...
   ![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14pffl21rj30za04rgod.jpg%29)

4. 执行结果

   ![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14pfu2awxj316t04f0tr.jpg%29)

##### 实验总结

- fork() 函数是为父进程创建一个只有pid等部分结构不同的子进程，直接复制PCB等

  ![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14pgeuoluj313a067t9y.jpg%29)
...
2. 实验结果
   ...
   ![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14pgw5qggj31a70pc79a.jpg%29)
...
- 编写代码
  ...
  ![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14pi95f7vj31710ke4bd.jpg%29)
...
- exit（）函数退出
  ...
  ![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14phnv0q1j316l0g7tjk.jpg%29)
...
- 段错误退出时
  ...
  ![](http://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/007bgNxTly1g14phb7tqvj31700grgxl.jpg%29)
