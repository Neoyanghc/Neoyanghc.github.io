...
![](https://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/20190507200607.png)

2. P_med 占用cpu，P_low放入等待队列ready_list,其还保存着对应的lock占用

   ![](https://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/20190507200450.png)

3. 此时P_high就绪，根据优先级调度其开始对CPU占用，P_med和P_low按序回到就绪队列中

   ![](https://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/20190507201630.png)
...
![](https://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/20190508082122.png)
...
![](https://jackyanghc-picture.oss-cn-beijing.aliyuncs.com/20190508083127.png)
